...
- [ ] TXXX [P] Additional automated tests for changed shared behavior in tests/unit/
- [ ] TXXX Security hardening
- [ ] TXXX Capture screenshots or recordings for user-facing changes on touched platforms
